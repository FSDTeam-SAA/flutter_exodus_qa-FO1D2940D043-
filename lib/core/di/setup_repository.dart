...
void setupRepository() {
  ...
  sl.registerCachedFactory<GetSingleBusRepository>(() => GetSingleBustRepositoryImpl(apiClient: sl()));
  sl.registerCachedFactory<CreateTicketRepository>(() => CreateTicketRepositoryImpl(apiClient: sl()));
}
